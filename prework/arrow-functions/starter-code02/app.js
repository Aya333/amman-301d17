...
//It's a keyword that refers to the object which in this example is(Joe) and the .scope to call constructor  that contains the object properties
// 2. What is "this" when joe.scopeArrow() is invoked?
//It refers to the whole scope object since arrow functions don't have their on (this) to use so we had to use another way
// 3. Explain why "this" is different when an arrow function is used.
//Because it uses the surrounding scope so it's different from the normal function
